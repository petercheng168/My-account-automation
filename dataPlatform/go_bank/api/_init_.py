...
class _init_(object):
    ...
    def __init__(self, protocol='http', host='10.6.1.43', port='8080',
                 basepath='/go-bank/v1', clientHeader='GO_CLIENT_HEADER', timeout='API_TIMEOUT'):
        ''' usage:
                __dirname = os.path.dirname(os.path.abspath(__file__))
            ...
            Note:
                - default host is `DATAPLATFORM_STG_HOST` and basepath is `/go-platform/v1`
        ...
        self.HOST = 'http://{}:{}{}'.format(host, port, basepath)
