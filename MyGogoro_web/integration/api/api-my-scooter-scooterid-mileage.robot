*** Settings ***
Documentation    Test suite for MyGogoro scooter mileage
Resource    ../../init.robot

Force Tags    MyGogoro    mileage
Suite Setup    Sign In New User
Test Setup    Test Setup
Test Timeout    ${TEST_TIMEOUT}

*** Test Case ***
Get user scooter mileage
    Add Scooter Mileage    ${Scooter.scooter_guid}    ${battery_guid0}    ${battery_guid1}\
    ...    ${battery_guid2}    ${battery_guid3}    45    45
    ${resp} =    Api My Scooter ScooterId Mileage Get    ${scooter_Id}    ${gogoro-sess}    ${csrf_token}
    Verify Status Code As Expected    ${resp}   200
    Verify Schema    ../../..MyGogoro_web/res/schema/api-my-scooter-scooterId-mileage.json    getScooterMileage    ${resp.json()}
    Verify Response Contains Expected    ${resp.json()['total']}    45
